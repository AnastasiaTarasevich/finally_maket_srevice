...
;// CONCATENATED MODULE: ./scripts/appearance/main_info/main_info.js
function main_info() {
  var revealButtonMain = document.querySelector('.main__info__reveal-part-button');
  var revealTextMain = document.querySelector('.main__info__reveal-part-text');
  var mainInfoDescription = document.querySelector('.main__info__description-text');
  var revealImageMain = document.querySelector('.main__info__reveal-part-img');
...
;// CONCATENATED MODULE: ./scripts/part_of_main/brand_list/brand_list.js
function brand_list() {
  var revealButton = document.querySelector('.brand__list__reveal-part__button');
  var revealText = document.querySelector('.brand__list__reveal-part__text');
  var revealImage = document.querySelector('.brand__list__reveal-part__img');
  var swiperWrapper = document.querySelector('.brand__list__items-packing.swiper-wrapper');
  ...
  var revealButtonFix = document.querySelector('.brand__list__reveal-part__button.swiper-fixing');
  var revealTextFix = document.querySelector('.brand__list__reveal-part__text.swiper-fixing');
  var revealImageFix = document.querySelector('.brand__list__reveal-part__img.swiper-fixing');
  var swiperWrapperFix = document.querySelector('.brand__list__items-packing.swiper-wrapper.swiper-fixing');
  ...
  var imgButtons = document.querySelectorAll('.brand__list__items-switching');
...
function modalka() {
  ...
  var openModalButtonMenu = document.querySelector('.navigation__help-button.header.menu');
  var menuModal = document.querySelector('.navigation');
  ...
  var closeModalButtonMenu = menuModal.querySelector('.navigation__button.cross');
...
;// CONCATENATED MODULE: ./scripts/part_of_main/swiper/swiper.js
...
;// CONCATENATED MODULE: ./scripts/part_of_main/index.js
